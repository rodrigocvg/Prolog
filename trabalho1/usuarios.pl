...
insere(IdUsu,UsuNome,UsuEmail,UsuDatanasc,UsuSexo,UsuCpf,UsuEnd,UsuCep,UsuBairro,UsuCid,IdEstado,UsuTele,UsuLog,UsuSen,UsuPrivi,UsuPrimei,UsuAtivo):-
    with_mutex(usuarios,
               assert_usuarios(IdUsu,UsuNome,UsuEmail,UsuDatanasc,UsuSexo,UsuCpf,UsuEnd,UsuCep,UsuBairro,UsuCid,IdEstado,UsuTele,UsuLog,UsuSen,UsuPrivi,UsuPrimei,UsuAtivo)).
...
remove(IdUsu,UsuNome,UsuEmail,UsuDatanasc,UsuSexo,UsuCpf,UsuEnd,UsuCep,UsuBairro,UsuCid,IdEstado,UsuTele,UsuLog,UsuSen,UsuPrivi,UsuPrimei,UsuAtivo):-
    with_mutex(usuarios,
               retract_usuarios(IdUsu,UsuNome,UsuEmail,UsuDatanasc,UsuSexo,UsuCpf,UsuEnd,UsuCep,UsuBairro,UsuCid,IdEstado,UsuTele,UsuLog,UsuSen,UsuPrivi,UsuPrimei,UsuAtivo)).
...
atualiza(IdUsu,UsuNome,UsuEmail,UsuDatanasc,UsuSexo,UsuCpf,UsuEnd,UsuCep,UsuBairro,UsuCid,IdEstado,UsuTele,UsuLog,UsuSen,UsuPrivi,UsuPrimei,UsuAtivo):-
    with_mutex(usuarios,
               (retractall_usuarios(IdUsu,UsuNome,UsuEmail,UsuDatanasc,UsuSexo,UsuCpf,UsuEnd,UsuCep,UsuBairro,UsuCid,IdEstado,UsuTele,UsuLog,UsuSen,UsuPrivi,UsuPrimei,UsuAtivo),
               assert_usuarios(IdUsu,UsuNome,UsuEmail,UsuDatanasc,UsuSexo,UsuCpf,UsuEnd,UsuCep,UsuBairro,UsuCid,IdEstado,UsuTele,UsuLog,UsuSen,UsuPrivi,UsuPrimei,UsuAtivo))).
