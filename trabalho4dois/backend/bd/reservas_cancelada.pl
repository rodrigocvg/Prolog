...
insere(Id,Id,Data,Hora,IdAmb,IdUs,Just,DateTime,UsExcl):-
    chave:pk(reservas_cancelada,Id),
    with_mutex(reservas_cancelada,
               assert_reservas_cancelada(Id,Id,Data,Hora,IdAmb,IdUs,Just,DateTime,UsExcl)).

remove(Id):-
    with_mutex(reservas_cancelada,
               retractall_reservas_cancelada(Id,_Id,_Data,_Hora,_IdAmb,_IdUs,_Just,_DateTime,_UsExcl)).

atualiza(Id,Id,Data,Hora,IdAmb,IdUs,Just,DateTime,UsExcl):-
    with_mutex(reservas_cancelada,
