...
tabela_de_categoria_ambiente -->
    html(div(class('container-fluid py-3'),
             [ \cabeca_da_tabela('Categoria ambientes', 'categoria_ambiente/cadastro'),
               \tabela
             ]
            )).
...
/* Página para edição (alteIdção) de um categoria_ambiente  */
